...
import MandalenChatWidget from "@/components/ui/mandalen-chat-widget"
...
const WhatsAppButton = () => {
  ...
  return (
    ...
    >
      <div className="relative">
        <div className="h-14 w-14 rounded-full bg-[#25D366] hover:bg-[#25D366]/90 flex items-center justify-center text-white shadow-2xl shadow-green-500/25 transition-all duration-300 group-hover:shadow-green-500/40">
          <WhatsAppIcon />
        </div>
        ...
        {/* Tooltip */}
        <div className="absolute left-full ml-4 top-1/2 transform -translate-y-1/2 bg-gray-900 dark:bg-gray-800 text-white px-3 py-2 rounded-lg text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none">
